  ...
  app: {
    head: {
      ...
      link: [
        ...
        // { rel: 'mask-icon', href: '/favicons/safari-pinned-tab.svg', color: '#1f8a70' },
      ],
      meta: [
        { charset: 'utf-8' },
        ...
        // { property: 'og:title', content: 'Рич-Фарма' },
        // { property: 'og:type', content: 'website' },
        // { property: 'og:url', content: '' },
        // {
        //   property: 'og:description',
        //   content: 'Добро пожаловать в Онлайн-Аптеку! Найти своё решение к здоровью стало проще',
        // },
        // {
